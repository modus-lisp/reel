...
(declaim (inline c8))
(defun c8 (v) (declare (type fixnum v)) (cond ((< v -128) -128) ((> v 127) 127) (t v)))
...
(defun common-adjust (use-outer data p1i p0i q0i q1i)
  (declare (type (simple-array fixnum (*)) data) (type fixnum p1i p0i q0i q1i))
...
(defun kernel-sub (data q0i s hthr ilim elim)
  (declare (type (simple-array fixnum (*)) data) (type fixnum q0i s hthr ilim elim))
    ...
    (when (filter-yes ilim elim data p3i p2i p1i p0i q0i q1i q2i q3i)
      (if (hev hthr data p1i p0i q0i q1i)
          ...
          (let* ((p2 (- (aref data p2i) 128)) (p1 (- (aref data p1i) 128))
            ...
            (declare (type fixnum p2 p1 p0 q0 q1 q2 w))
